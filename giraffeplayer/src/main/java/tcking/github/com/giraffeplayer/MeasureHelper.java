...
public final class MeasureHelper {
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        float scaleRatio = 1;
        int screenWidth = getScreenWidth(mWeakView.get().getContext());
        int screenHeight = getScreenHeight(mWeakView.get().getContext());
                ...
                switch (mCurrentAspectRatio) {
                    case IRenderView.AR_16_9_FIT_PARENT:
                        ...
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270) {
                            ...
                            scaleRatio = screenHeight * 1.0f / screenWidth;
                        }
                        break;
        ...
        if (height > screenHeight) {
            width = (int) (width * screenHeight * 1.0f / height);
            height = screenHeight;
        }
